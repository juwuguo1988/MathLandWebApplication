...
class FreeCreationActivity : AppCompatActivity() {
    ...
    private val onClickListener = View.OnClickListener { view ->
        when (view.id) {
            ...
            R.id.btnSkip -> {
                val sampleDir: String = FileUtils.getFreeCreationFilePath(this) + "MathLand/web-mobile/"
    ...
    private fun localJsonFile(): File {
        ...
        val tmpDir: String = FileUtils.getFreeCreationFilePath(this)
