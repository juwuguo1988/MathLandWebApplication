...
class TeacherLessonActivity : AppCompatActivity() {
    ...
    private val onClickListener = View.OnClickListener { view ->
        when (view.id) {
            ...
            R.id.btnSkip -> {
                val sampleDir: String = FileUtils.getTeacherLessonFilePath(this) + "MathLand/web-mobile-course/"
    ...
    private fun localJsonFile(): File {
        val fileName = "lessonConfig-course"
        val tmpDir: String = FileUtils.getTeacherLessonFilePath(this)
    ...
    private fun downloadFile() {
        val fileName = "web-mobile-course"
        val tmpDir: String = FileUtils.getTeacherLessonFilePath(this)
        val destFileDir = "$tmpDir/MathLand"
