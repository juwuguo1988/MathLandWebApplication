...
import com.codemao.land.utils.okhttp.utils.Exceptions;
...
public abstract class OkHttpRequest {
    ...
    public OkHttpRequest(String url) {
        ...
        this.params = null;
        headers = new HashMap<>();
        //headers.put("Authorization", "Bearer " + UserInfoUtils.getAccessToken(XZLApplication.getContext()));
        if (url == null) {
            Exceptions.illegalArgument("url can not be null.");
        }
