...
public class RequestCall {
	...
	public Call buildCall(Callback callback) {
		...
		if (readTimeOut > 0 || writeTimeOut > 0 || connTimeOut > 0) {
			...
			clone = OkHttpUtils.getInstance().getOkHttpClient().newBuilder().readTimeout(readTimeOut, TimeUnit.MILLISECONDS).writeTimeout(writeTimeOut, TimeUnit.MILLISECONDS)
